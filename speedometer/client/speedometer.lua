...
function Speedometer:__init()
	...
	Events:Subscribe("SendFuel", self, self.GetFuel)
end

function Speedometer:GetFuel(Fuel)
	self.fuel = Fuel
end
...
function Speedometer:Render()
	...
	-- Fuel Function
	local BarPosFuel = Vector3( 0, text_size.y + 22, 0 )
	...
	Render:FillArea( 
        BarPosFuel, 
        Vector3( text_size.x * self.fuel, 16, 0 ), Color(255, 255, 0))
end
